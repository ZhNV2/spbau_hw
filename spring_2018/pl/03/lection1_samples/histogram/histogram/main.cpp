...
int main()
{
   ...
   try {
      ...
      queue.finish();
      cl::Kernel kernel_gmem(program, "gpu_histogram_naive");
      cl::KernelFunctor histogram_naive(kernel_gmem, queue, cl::NullRange, cl::NDRange(test_array_size), cl::NDRange(block_size));
      cl::Event event = histogram_naive(dev_input, dev_output);
